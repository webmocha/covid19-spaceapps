...
for filename in os.listdir(csvDir):
    ...
    with open(os.path.join(csvDir, filename), 'r') as csvfile:
        ...
        for row in reader:
            ...
            row['aerosolOpticalThickness_0-76'] = row.pop('aerosolOpticalThickness(0.76)')
            row['aerosolOpticalThickness_1-6'] = row.pop('aerosolOpticalThickness(1.6)')
            row['aerosolOpticalThickness_2-06'] = row.pop('aerosolOpticalThickness(2.06)')
